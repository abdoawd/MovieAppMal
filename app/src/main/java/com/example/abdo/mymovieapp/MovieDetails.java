...
public class MovieDetails extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        movie=getIntent().getParcelableExtra("parcell");
        if (savedInstanceState==null){
            getFragmentManager().
                    beginTransaction().add(R.id.citain, new MyFragmentDetails())
                    .commit();}
        }
    ...
    public class MyFragmentDetails extends Fragment {
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            button= (Button) layout.findViewById(R.id.button3);
                ...
                original_title.setText(model.original_title);
                release.setText(model.release_date);
                vote.setText(model.vote_average);
                Picasso.with(getActivity()).load(yy+model.poster_path).resize(500,500).into(imageView);
        ...
        public  class Async extends AsyncTask<String,Void,ArrayList<video>> {
            ...
            protected ArrayList<video> doInBackground(String... params) {
                ...
                try {
                    ...
                    URL url1 = new URL("http://api.themoviedb.org/3/movie/"+model.id+"/videos?api_key="+MovieSchema.api
                    );
        ...
        public  class Asyncc extends AsyncTask<String,Void,ArrayList<String>> {
            ...
            protected ArrayList<String> doInBackground(String... params) {
                ...
                String tsonstring = null;
                try {
                    URL url1 = new URL("http://api.themoviedb.org/3/movie/"+model.id+"/reviews?api_key="+MovieSchema.api
                    );
